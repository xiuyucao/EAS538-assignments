...
* *Differences:* 
  ...
  * Second model's F-statistic decreases due to the reduced dof
* *Similarities:*
...
## Question 3.2
**Answer:** In a previous course project, I was trying to predict urbanization using variables including the distance to parks, forests, roads, water, and the elevation. I was trying to get a generalized model that can predict urbanization across the US, instead of the only a few states whose data I have access to. Also, in this case I believe I have collected enough data of factors and I don't think there is a problem of OVB. Therefore, in this case a random effect on the states would be more appropriate than a fixed effect.
